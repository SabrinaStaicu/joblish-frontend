                ...
                <div >
                    ...
                    <ul class="ul-style">
                            ...
                            <Grid container spacing={2}>
                                <Grid item xs={12} sm={6}>
                                    <TextField
                                        ...
                                        autoFocus
                                    />
                                    {errors.title && <span class="required-field-error-1">This field is required!</span>}
                                    </Grid>
                            </Grid>
                        ...
                        <Grid container spacing={2}>
                                <Grid item xs={12} sm={6}>
                                    <TextField
                                        ...
                                        autoFocus
                                    />
                                    {errors.location && <span class="required-field-error-1">This field is required!</span>}
                                    </Grid>
                            </Grid>
                        ...
                        <li class="ul-li-h3">
                            ...
                            <h3 class="ul-li-h3-2">Start date</h3>
